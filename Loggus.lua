...
titleLabel.Text = "Animation Logger - ZVX"
...
local function logAnimation(animationName, animationId)
    ...
    logEntry.Text = string.format("%s\nAnimation ID: %d\nCopy as Library Link: %s", animationName, numericId, linkStatus)
...
optionalSettingToggle.Text = "Copy as Library Link"
